...
abstract class Tile extends PMTile {
    /** @var string */
    public const
      BEACON = "Beacon", MOB_SPAWNER = "MobSpawner", SHULKER_BOX = "ShulkerBox", HOPPER = "Hopper", JUKEBOX = "Jukebox", CAULDRON = "Cauldron";
    
    public static function init(){
        TableSpoon::getPluginLogger()->debug("Registering Tiles...");
        try{
