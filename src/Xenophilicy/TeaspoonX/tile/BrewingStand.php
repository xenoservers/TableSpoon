...
use Xenophilicy\TableSpoon\inventory\BrewingInventory;
...
class BrewingStand extends Spawnable implements InventoryHolder, Container, Nameable {
    ...
    /**
     * @return \pocketmine\inventory\Inventory|BrewingInventory
     */
    ...
    public function onUpdate(): bool{
        if($this->isClosed() || !TableSpoon::$brewingStandsEnabled){
            return false;
        }
