...
class CommandManager {
    public static function init(){
        TableSpoon::getPluginLogger()->debug("Registering Commands...");
        $cmds = [new WorldCommand("world"), new ClearCommand("clear"), new PlaySoundCommand("playsound"), new BugReportCommand("bugreport"),];
