...
class WeatherCommand extends VanillaCommand {
    ...
    public function execute(CommandSender $sender, $currentAlias, array $args){
        ...
        if($sender instanceof Player){
            ...
            if(!isset($args[1])) $duration = mt_rand(min(TableSpoon::$weatherMinTime, TableSpoon::$weatherMaxTime), max(TableSpoon::$weatherMinTime, TableSpoon::$weatherMaxTime));else $duration = (int)$args[1];
            if($wea >= 0 and $wea <= 3){
