...
use Xenophilicy\TableSpoon\item\EnchantedBook;
...
class TestCommand extends VanillaCommand {
    ...
    public function __construct($name){
        parent::__construct($name, "Xenophilicy\TeaspoonX's Command to test stuff", "/test");
    }
                ...
                switch($args[0]){
                    ...
                    case "opEnchBook":
                        ...
                        if($i instanceof EnchantedBook){
                            foreach([new EnchantmentInstance(Enchantment::getEnchantment(Enchantment::SHARPNESS), 32767), new EnchantmentInstance(Enchantment::getEnchantment(Enchantment::KNOCKBACK), 32767), new EnchantmentInstance(Enchantment::getEnchantment(Enchantment::UNBREAKING), 32767), new EnchantmentInstance(Enchantment::getEnchantment(Enchantment::LOOTING), 32767),] as $enchantment){
