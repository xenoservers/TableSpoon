...
class EntityManager extends Entity {
    public static function init(): void{
        // TODO: MobAI...
        TableSpoon::getPluginLogger()->debug("Registering Entities...");
        if(TableSpoon::$registerVanillaEntities){
        ...
        //		if(strtolower(TableSpoon::$cars) === "true"){
        //			TableSpoon::getPluginLogger()->debug("Using Minecart Vanilla");
        //			self::registerEntity(Minecart::class, true, ['Minecart', 'minecraft:minecart']);
        //		} else if(strtolower(TableSpoon::$cars) === "false") {
        //			TableSpoon::getPluginLogger()->debug("Using Minecart Genisys");
