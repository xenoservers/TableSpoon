            ...
            if(!isset(TableSpoon::$onPortal[$entity->getId()])){
                ...
                if($entity instanceof Player){
                    if($entity->getLevel() instanceof Level){
                        ...
                        if($entity->getLevel()->getName() != TableSpoon::$endName){ // OVERWORLD -> END
                            ...
                            $plug->getScheduler()->scheduleDelayedTask(new DelayedCrossDimensionTeleportTask($entity, DimensionIds::OVERWORLD, TableSpoon::$overworldLevel->getSafeSpawn()), 1);
                        }
                    }
                }
