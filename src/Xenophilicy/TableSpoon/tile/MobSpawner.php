...
class MobSpawner extends Spawnable {
    ...
    /** @var string */
    public const
      TAG_ENTITY_ID = "EntityId", TAG_SPAWN_COUNT = "SpawnCount", TAG_SPAWN_RANGE = "SpawnRange", TAG_MIN_SPAWN_DELAY = "MinSpawnDelay", TAG_MAX_SPAWN_DELAY = "MaxSpawnDelay", TAG_DELAY = "Delay";
    /** @var int */
    ...
    public function onUpdate(): bool{
        ...
        if($this->canUpdate() && TableSpoon::$settings["blocks"]["spawners"]["enabled"]){
            if($this->delay <= 0){
                $success = false;
